...
export default function TuitionSchedulePage() {
    ...
    const [tuitions, setTuitions] = useState<TuitionSchedule[]>([]);
    ...
    const handleAdd = () => router.push('/admin/tuition/schedule/add');

    const handleEdit = (id: string) => router.push(`/admin/tuition/schedule/update/${id}`);
            ...
            <Container maxWidth="xl">
                ...
                <Paper sx={{ p: 3, borderRadius: 2 }}>
                    <Stack direction="row" spacing={2} sx={{ mb: 3, alignItems: 'center' }}>
                        <TextField
                            variant="outlined"
                            placeholder="Tìm kiếm theo mô tả hoặc đợt..."
                            value={searchQuery}
                        ...
                        <Table>
                            <TableHead sx={{ bgcolor: 'var(--primary-color)' }}>
                                <TableRow>
                                    ...
                                    <TableCell sx={{ color: '#fff', fontWeight: 600 }}>Đợt</TableCell>
                                    <TableCell sx={{ color: '#fff', fontWeight: 600 }}>Ngày Nộp</TableCell>
                                    <TableCell sx={{ color: '#fff', fontWeight: 600 }}>Số Tháng</TableCell>
                            ...
                            <TableBody>
                                {tuitions.map((tuition) => (
                                    <TableRow key={tuition._id} hover>
                                        ...
                                        <TableCell>{tuition.months}</TableCell>
